...
int main(int /* argc */, char** /* argv */) {
	...
	int idPremierNoeud = 0;
    int idDernierNoeud = 29;
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (placementTour == true) {
			...
			if (typeTourSelectionnee == 1) {
				...
				glTexCoord2f(1, 1); glVertex3f(1.f, 1.2f, 0.0005);
				glTexCoord2f(0, 1); glVertex3f(0.f, 1.2f,0.0005);
				glEnd();
			...
			if (typeTourSelectionnee == 2) {
				...
				glTexCoord2f(0, 0); glVertex3f(0.f, 0.f, 0.0005);
				glTexCoord2f(1, 0); glVertex3f(1.f, 0.f, 0.0005);
				glTexCoord2f(1, 1); glVertex3f(1.f, 1.5f, 0.0005);
				glTexCoord2f(0, 1); glVertex3f(0.f, 1.5f, 0.0005);
				glEnd();
				glPopMatrix();
				glBindTexture(GL_TEXTURE_2D, 0);
			}
		...
		for (int i = 0; i < Jeu::prochainEnnemiAAfficher; ++i){
			if (!Jeu::vaguesEnnemis[Jeu::vagueActuelle][i].estMort() && JeuACommence == true) {
				...
				glBegin(GL_QUADS);
				glTexCoord2f(0, 0); glVertex3f(-0.5f, -0.5f, 0.001 + i * 0.001);
				glTexCoord2f(1, 0); glVertex3f(0.5f, -0.5f, 0.001 + i * 0.001);
				glTexCoord2f(1, 1); glVertex3f(0.5f, 0.5f, 0.001 + i * 0.001);
				glTexCoord2f(0, 1); glVertex3f(-0.5f, 0.5f, 0.001 + i * 0.001);
				glEnd();
				glPopMatrix();
				glBindTexture(GL_TEXTURE_2D, 0);
			}	
		...
		for (auto it = Jeu::projectiles.begin(); it != Jeu::projectiles.end(); /* pas d'incrémentation ici */) {
			...
			glPushMatrix();
			glTranslatef(it->PositionX + 0.5f, it->PositionY + 0.5f, 0); // Déplacer l'origine au centre du projectile
			glScalef(0.3f, 0.3f, 1.0f); // Ajuster la taille du projectile
			glBegin(GL_QUADS);
			glTexCoord2f(0, 0); glVertex3f(-0.5f, -0.5f, 0.2);
			glTexCoord2f(1, 0); glVertex3f(0.5f, -0.5f, 0.2);
			glTexCoord2f(1, 1); glVertex3f(0.5f, 0.5f, 0.2);
			glTexCoord2f(0, 1); glVertex3f(-0.5f, 0.5f, 0.2);
			glEnd();
			glPopMatrix();
			glBindTexture(GL_TEXTURE_2D, 0);
		...
		// La partie qui suit a pour but d'afficher les coeurs du joueur
		for (int i {0}; i < Jeu::points_de_vieJoueur; i++) {
			glBindTexture(GL_TEXTURE_2D, tab2[4]);
			glPushMatrix();
			glTranslatef(6 + i*2.5  , 5, 1);
			glScalef(1.5f, 1.5f, 1.0f);
			glBegin(GL_QUADS);
			glTexCoord2f(0, 0); glVertex3f(-0.5f, -0.5f, 0.1);
			glTexCoord2f(1, 0); glVertex3f(0.5f, -0.5f, 0.1);
			glTexCoord2f(1, 1); glVertex3f(0.5f, 0.5f, 0.1);
			glTexCoord2f(0, 1); glVertex3f(-0.5f, 0.5f, 0.1);
			glEnd();
			glPopMatrix();
			glBindTexture(GL_TEXTURE_2D, 0);
		}
		...
		for (int i = 0; i < argentStr.size(); i++) {
			...
			// Affichage pièce d'or
			glBindTexture(GL_TEXTURE_2D, tab2[5]);  // Utiliser la texture de la pièce d'or
			glPushMatrix();
		...
		// La partie qui suit a pour but d'afficher les tours achetables
		int prixTourA = 100;
    	int prixTourB = 200;
		...
		glBegin(GL_QUADS);
		glTexCoord2f(0, 0); glVertex3f(-1.f, -1.25f, 0.1);
		glTexCoord2f(1, 0); glVertex3f(1.f, -1.25f, 0.1);
		glTexCoord2f(1, 1); glVertex3f(1.f, 1.25f, 0.1);
		glTexCoord2f(0, 1); glVertex3f(-1.f, 1.25f, 0.1);
		glEnd();
		glPopMatrix();
		glBindTexture(GL_TEXTURE_2D, 0);
		...
		glScalef(0.75f, 0.75f, 1.0f);
		glBegin(GL_QUADS);
		glTexCoord2f(0, 0); glVertex3f(-1.f, -1.5f, 0.1);
		glTexCoord2f(1, 0); glVertex3f(1.f, -1.5f, 0.1);
		glTexCoord2f(1, 1); glVertex3f(1.f, 1.5f, 0.1);
		glTexCoord2f(0, 1); glVertex3f(-1.f, 1.5f, 0.1);
		glEnd();
		glPopMatrix();
		glBindTexture(GL_TEXTURE_2D, 0);
		...
		glScalef(0.75f, 0.77f, 1.0f);
		glBegin(GL_QUADS);
		glTexCoord2f(0, 0); glVertex3f(-0.5f, -0.5f, 0.1f);
		glTexCoord2f(1, 0); glVertex3f(0.5f, -0.5f, 0.1f);
		glTexCoord2f(1, 1); glVertex3f(0.5f, 0.5f, 0.1f);
		glTexCoord2f(0, 1); glVertex3f(-0.5f, 0.5f, 0.1f);
		glEnd();
		glPopMatrix();
		glBindTexture(GL_TEXTURE_2D, 0);
		...
		glBegin(GL_QUADS);
		glTexCoord2f(0, 0); glVertex3f(-2.0f, -0.5f, 0.1f);
		glTexCoord2f(1, 0); glVertex3f(2.0f, -0.5f, 0.1f);
		glTexCoord2f(1, 1); glVertex3f(2.0f, 0.5f, 0.1f);
		glTexCoord2f(0, 1); glVertex3f(-2.0f, 0.5f, 0.1f);
		glEnd();
		glPopMatrix();
		glBindTexture(GL_TEXTURE_2D, 0);
		...
		if (Jeu::finDuJeuVictorieuse == 1) {
			...
			glScalef(1.0f, 1.0f, 1.0f);
			glBegin(GL_QUADS);
			glTexCoord2f(0, 0); glVertex3f(-2.0f, -0.5f, 0.2);
			glTexCoord2f(1, 0); glVertex3f(2.0f, -0.5f, 0.2);
			glTexCoord2f(1, 1); glVertex3f(2.0f, 1.f, 0.2);
			glTexCoord2f(0, 1); glVertex3f(-2.0f, 1.f, 0.2);
			glEnd();
			glPopMatrix();
			glBindTexture(GL_TEXTURE_2D, 0);
		}
		...
		if (JeuACommence == false) {
			...
			glTexCoord2f(0, 0); glVertex3f(-2.0f, -0.5f, 0.2);
			glTexCoord2f(1, 0); glVertex3f(2.0f, -0.5f, 0.2);
			glTexCoord2f(1, 1); glVertex3f(2.0f, 0.5f, 0.2);
			glTexCoord2f(0, 1); glVertex3f(-2.0f, 0.5f, 0.2);
			glEnd();
			glPopMatrix();
			glBindTexture(GL_TEXTURE_2D, 0);
		}
